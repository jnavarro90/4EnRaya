 ...
 * modificación por medio del controlador Partida.java se lo notifica para que
 * haga los cambios oportunos en la vista.
 */
package modelo;
...
public class Tablero extends Observable implements Serializable {
    ...
    /**
     * El metodo jugada comprobara si se puede hacer la jugada que el jugador ha
     * introducido
     *

 ...
 * pequeños cambios en relación a versión 1 la má importante es que la mayor
 * parte del método jugar() ha pasado a ser parte del metodo del Observer
 * update() ya que tiene que recibir la Casilla que le pase la clase a la que
 * observa que es la clase TableroVista del paquete de la vista.
 */
package controlador;
...
public class Partida implements Observer {
    ...
    /**
     * El metodo guardar serializa el tablero y los dos jugadores, con eso esta
     * controlado todo lo que hay en la partida en ficheros con un codigo hash
     * conjunto de los jugadores con cada uno de sus nombres y con el tablero,
     * si dos jugadores ya tenian una partida guardada la sobreescribe.
     *
    ...
    /**
     * El metodo cargar solo cargara si los dos nombres coinciden con el de una
     * partida ya guardada con el codigo hash usado en la clase guardar.
     *
    ...
    /**
     * Cambia la variable turno del jugador1 de valor, aunque los dos tienen una
     * variable turno se puede controlar solo con uno de los jugadores.
     */
